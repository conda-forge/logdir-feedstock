...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/logdir-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12032&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/logdir-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `logdir` can be installed with:

```
conda install logdir
```

It is possible to list all of the versions of `logdir` available on your platform with:
